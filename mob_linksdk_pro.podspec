Pod::Spec.new do |s|
	...
	s.source              = { :http => 'https://sdk-dev-ios.oss-cn-hangzhou.aliyuncs.com/files/download/moblinkpro/MobLinkPro_For_iOS_v3.3.20.zip' }

	s.platform            = :ios, '8.0'
	s.frameworks          = "ImageIO", "JavaScriptCore"
	s.libraries           = "icucore", "z", "c++", "sqlite3"
	s.vendored_frameworks = 'MobLinkPro/MobLinkPro.xcframework'
