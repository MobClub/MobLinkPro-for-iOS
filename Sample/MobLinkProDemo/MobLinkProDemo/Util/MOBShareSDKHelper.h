...
*/
    ...
    //AppKey
    #define MOBSSDKSinaWeiboAppKey @"474962333"
    //AppSecret
    #define MOBSSDKSinaWeiboAppSecret @"26522c6ed236057fd4ff5005449f98e9"
    //RedirectUri
...
*/
    ...
    //AppID
    #define MOBSSDKFacebookAppID @"148252749452354"
    //AppSecret
    #define MOBSSDKFacebookAppSecret @"98fd1841249cdf2c32755bd6571fada8"
    //displayName facebook客户端分享必须
    #define MOBSSDKFacebookDisplayName @"MobLink"
    //AuthType 授权优先类型 web sso both
