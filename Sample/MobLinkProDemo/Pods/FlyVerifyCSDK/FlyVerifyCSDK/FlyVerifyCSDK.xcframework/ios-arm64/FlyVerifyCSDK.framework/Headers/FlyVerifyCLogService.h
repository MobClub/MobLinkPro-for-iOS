...
@class FlyVerifyCLogService;


/**
 日志服务协议
 */
@protocol FlyVerifyCLogServiceDelegate <NSObject>
 ...
 */
- (BOOL)logService:(FlyVerifyCLogService *)logService
 ...
 */
- (void)logService:(FlyVerifyCLogService *)logService
...
/**
 日志服务
 */
@interface FlyVerifyCLogService : NSObject

/**
 委托对象
 */
@property (nonatomic, weak) id<FlyVerifyCLogServiceDelegate> delegate;
