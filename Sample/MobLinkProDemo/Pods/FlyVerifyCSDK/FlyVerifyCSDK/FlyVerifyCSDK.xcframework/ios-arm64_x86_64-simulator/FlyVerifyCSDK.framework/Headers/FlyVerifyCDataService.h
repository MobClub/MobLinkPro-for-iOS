//
//  FlyVerifyCDataService.h
//  FlyVerifyCSDK
//
//  Created by flyverify on 15-1-21.
 ...
 *  数据服务
 */
@interface FlyVerifyCDataService : NSObject
 ...
 *  @return 数据服务对象
 */
+ (FlyVerifyCDataService *)sharedInstance;
...
//获取秒验的数据
- (id)cacheDataForKeyOld:(NSString *)key domain:(NSString *)domain;
...
//兼容秒验
- (id)secureDataForKeyOld:(NSString *)key;
@end
