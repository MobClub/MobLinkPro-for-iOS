...
#import "IFlyVerifyCBaseUser.h"
#import "FlyVerifyCDataModel.h"

/**
 用户信息
 */
@interface FlyVerifyCUser : FlyVerifyCDataModel <IFlyVerifyCBaseUser>
...
/**
 ...
 @return 用户信息
 */
+ (FlyVerifyCUser* _Nullable)userWithUid:(NSString * _Nonnull)uid
...
/**
 ...
 @return 用户信息
 */
+ (FlyVerifyCUser* _Nullable)userWithAppUid:(NSString * _Nonnull )appUid
                               avatar:(NSString * _Nullable)avatar
