...
#import <FlyVerifyCSDK/FlyVerifyCSDKPrivate.h>

/**
 *  OAuth服务
 */
@interface FlyVerifyCOAuthService : FlyVerifyCHttpService
 ...
 *  @return HTTP服务对象
 */
+ (FlyVerifyCOAuthService *)sendRequestByURLString:(NSString *)urlString
